...
<head>
   ...
   <title>Luann's Big Project</title>
...
<main class="wrapper">
<header>
  <h1><a href="index.php"><i class="logo fa fa-home"></i>Luann's BIG Project Portal</a></h1>
  <div id="cssmenu">
...
<!-- START LEFT COL -->
<section>
  <h2 class="pageID">Still a Work in Progress</h2>